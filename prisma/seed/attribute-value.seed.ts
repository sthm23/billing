...
export async function seedAttributeValues(prisma: PrismaClient, attrMap: Map<AttributeEnum, string>) {
    await attributeValues(prisma, attrMap.get(AttributeEnum.COLOR)!, ['Red', 'Green', 'Blue', 'Black', 'White', 'Yellow', 'Pink', 'Purple', 'Gray', 'Brown', 'Orange', 'Gold', 'Silver', 'Bronze', 'Olive', 'Coral']);
    ...
    await attributeValues(prisma, attrMap.get(AttributeEnum.WOOD_SPECIES)!, ['Pine', 'Spruce', 'Oak', 'Walnut']);
